...
class ExamController extends Controller
{
    ...
    {
        $request->validate([
            'type' => 'required|in:tab_switch,window_blur,copy_paste,right_click,shortcut_key,screen_capture,multiple_face,no_face,head_turn,eye_gaze,identity_mismatch,split_screen,floating_app,pip_mode,suspicious_resize,screenshot_attempt,virtual_camera,camera_off,fullscreen_exit',
            'description' => 'nullable|string',
