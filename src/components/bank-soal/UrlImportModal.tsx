            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select value={formData.difficulty} onChange={(e) => setFormData(prev => ({ ...prev, difficulty: e.target.value as 'mudah' | 'sedang' | 'sulit' }))} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-sm font-medium text-gray-700">Pilih Soal untuk Diimport</label>
                ...
                <div className="border rounded-lg max-h-64 overflow-y-auto divide-y">
                  {previewResult.questions.map((q) => (
                    <div key={q.number} className={`p-3 cursor-pointer hover:bg-gray-50 ${selectedQuestions.includes(q.number) ? 'bg-teal-50' : ''}`} onClick={() => toggleQuestion(q.number)}>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm text-gray-900 line-clamp-2"><span className="font-medium">#{q.number}.</span> {q.question}</p>
