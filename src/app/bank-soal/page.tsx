                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-1 flex-shrink-0">
                        <button onClick={() => handleDuplicate(question)} className="p-2 text-slate-500 hover:text-sky-500 hover:bg-sky-50 rounded-lg" title="Duplikat" aria-label="Duplikat soal"><Copy className="w-4 h-4" /></button>
                        <button onClick={() => handleEdit(question)} className="p-2 text-slate-500 hover:text-sky-500 hover:bg-sky-50 rounded-lg" title="Edit" aria-label="Edit soal"><Edit className="w-4 h-4" /></button>
